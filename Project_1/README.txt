...
The client must send the first message. By typing \quit in either the client or server will terminate the connection of the client.
To exit the server please type Ctlr-C.
